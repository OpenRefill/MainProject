...
/*---- outbox---*/
extern DxClientOutbox dxOutbox;
 ...
 */
const char AZURE_IOT_STATUS_LU[4][20] ={
  "DISCONNECTED",
  "CONNECTING",
  "CONNECTED",
  "ERRROR"
 ...
 * @param[in]    is_dispense  Message is a dispense message, add to outbox
 * 
 * @return       int          0 on success, or non-zero if any failure occurs.
 */
...
/*---- outbox---*/
// void dxOutboxResendNext(uint32_t time_millis);
